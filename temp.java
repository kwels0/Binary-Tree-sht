...
public class tst {
	...
	public static void main(String[] args)
	{
        ...
        int nodes = myObj.nextInt();
        obj.nodesnumber(nodes);
        System.out.print("Input root value: ");        
        String root = myObj.nextLine();
		obj.Root(root);
		obj.set_Left("B", 0);
		obj.set_Right("C", 0);
		obj.set_Left("D", 1);
...
class Array_imp {
    ...
    public void nodesnumber(int nodes2) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'nodesnumber'");
    }
